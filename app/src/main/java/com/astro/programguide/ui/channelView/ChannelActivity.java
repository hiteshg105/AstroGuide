...
public class ChannelActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    int                     topFragment      = 0;
    public static final int CHANNEL_FRAGMENT = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            targetFragment = ChannelFragment.newInstance(0);
            fragmentManager.beginTransaction().replace(R.id.root_layout, targetFragment).commit();
        }
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_channels) {
            ...
            targetFragment = EventsFragment.newInstance(0);
        }
        fragmentManager.beginTransaction().replace(R.id.root_layout, targetFragment).commit();
